...
def test_serializer(app):
    """Test serializer."""
    csv = CSVSerializer(csv_included_fields=[
        ...
        'realizationFramework', 'funding_funder_type', 'funding_funder_name',
        'funding_funder_number', 'funding_fundingReceived', 'actorsInvolved',
        'benefits', 'impactOnFormation', 'impactOnProfessionalEnvironment',
        ...
        'hits': {
            'hits': [{
                ...
                'metadata': {
                    ...
                    ['Master of Advanced Studies', 'CAS or DAS'],
                    'status':
                    'In progress',
                    'relatedToMandate': {
                        'name': 'Bern',
    ...
    records['hits']['hits'][0]['metadata']['promoteInnovation'][
        'choice'] = False
    records['hits']['hits'][0]['metadata']['relatedToMandate'][
        'choice'] = False
    records['hits']['hits'][0]['metadata']['educationalDocument'][
        'choice'] = False
    records['hits']['hits'][0]['metadata']['externalPartners'][
        'choice'] = False
