...
def test_ark_disabled_cli(app, script_info):
    ...
    # server status
    result = runner.invoke(cli.ark, ["config"], obj=script_info)
...
def test_ark_cli_cfg(app, script_info):
    ...
    # ark server config
    result = runner.invoke(cli.config, obj=script_info)
...
def test_ark_cli_create_missing_org_not_exists(app, script_info):
    ...
    runner = CliRunner()
    # ark server config
    result = runner.invoke(cli.create_missing, ["foo"], obj=script_info)
...
def test_ark_cli_create_missing_no_doc(app, script_info, organisation):
    ...
    runner = CliRunner()
    result = runner.invoke(cli.create_missing, ["org"], obj=script_info)
