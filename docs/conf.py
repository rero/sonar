...
g = {}
with open(
    os.path.join(os.path.dirname(__file__), "..", "sonar", "version.py"), "rt"
) as fp:
    exec(fp.read(), g)
...
latex_documents = [
    (master_doc, "sonar.tex", u"sonar Documentation", u"RERO", "manual")
]
...
man_pages = [(master_doc, "sonar", u"sonar Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "sonar",
        u"Swiss Open Access Repository Documentation",
        author,
        "sonar",
