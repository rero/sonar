...
I18N_LANGUAGES = [("fr", _("French")), ("de", _("German")), ("it", _("Italian"))]
...
SQLALCHEMY_DATABASE_URI = "postgresql+psycopg2://sonar:sonar@localhost/sonar"
...
RECORDS_REST_ENDPOINTS = {
    ...
    "org": dict(
        ...
        record_serializers={
            "application/json": (
                "sonar.modules.organisations.serializers" ":json_v1_response"
            ),
        },
        search_serializers={
            "application/json": (
                "sonar.modules.organisations.serializers" ":json_v1_search"
            ),
        },
        record_loaders={
            "application/json": ("sonar.modules.organisations.loaders" ":json_v1"),
        },
    ...
    "user": dict(
        ...
        search_index="users",
        record_serializers={
            "application/json": ("sonar.modules.users.serializers" ":json_v1_response"),
        },
        search_serializers={
            "application/json": ("sonar.modules.users.serializers" ":json_v1_search"),
        },
        record_loaders={
            "application/json": ("sonar.modules.users.loaders" ":json_v1"),
        },
        list_route="/users/",
    ...
    "depo": dict(
        ...
        record_serializers={
            "application/json": (
                "sonar.modules.deposits.serializers" ":json_v1_response"
            ),
        },
        search_serializers={
            "application/json": (
                "sonar.modules.deposits.serializers" ":json_v1_search"
            ),
        },
        record_loaders={
            "application/json": ("sonar.modules.deposits.loaders" ":json_v1"),
        },
        list_route="/deposits/",
...
RECORDS_REST_FACETS = {
    "documents": dict(
        ...
        filters={
            "masked": and_term_filter("masked"),
            "subdivision": and_term_filter("subdivisions.pid"),
            "organisation": and_term_filter("organisation.pid"),
            "language": and_term_filter("language.value"),
            "subject": and_term_filter("facet_subjects"),
            "collection": and_term_filter("collections.pid"),
            "document_type": and_term_filter("documentType"),
            "controlled_affiliation": and_term_filter(
                "contribution.controlledAffiliation.raw"
            ),
            "author": and_term_filter("contribution.agent.preferred_name.raw"),
            "year": range_filter(
                "provisionActivity.startDate", format="yyyy", end_date_math="/y"
            ),
            "open_access": and_term_filter("isOpenAccess"),
            "customField1": and_term_filter("customField1.raw"),
            "customField2": and_term_filter("customField2.raw"),
            "customField3": and_term_filter("customField3.raw"),
        },
    ),
    "deposits": dict(
        aggs=dict(
...
RECORDS_REST_SORT_OPTIONS = {
    "documents": {
        ...
        "newest": {"fields": ["-provisionActivity.startDate"]},
        "oldest": {"fields": ["provisionActivity.startDate"]},
        "title": {"fields": ["title.mainTitle.value.raw"]},
    },
    "users": {
        "relevance": {
            "fields": ["-_score"],
        },
        "newest": {"fields": ["-_created"]},
        "oldest": {"fields": ["_created"]},
        "name": {"fields": ["full_name.raw"]},
    },
    "organisations": {
        "relevance": {
            "fields": ["-_score"],
...
for index in INDEXES:
    RECORDS_REST_DEFAULT_SORT[index] = {"query": "relevance", "noquery": "newest"}
...
OAUTHCLIENT_REMOTE_APPS["orcid"]["signup_handler"][
    "info"
...
SHIBBOLETH_SERVICE_PROVIDER = dict(
    strict=True, debug=True, entity_id="https://sonar.ch/shibboleth"
)
...
SHIBBOLETH_IDENTITY_PROVIDERS = dict(
    ...
    eduid=dict(
        entity_id="https://eduid.ch/idp/shibboleth",
        title="SWITCH edu-ID",
...
FILES_REST_PERMISSION_FACTORY = "sonar.modules.permissions.files_permission_factory"
...
STATS_EVENTS = {
    ...
    "record-view": {
        ...
        "event_builders": ["sonar.stats_event_builders" ".record_view_event_builder"],
        "cls": EventsIndexer,
        "params": {
            "preprocessors": [
                "invenio_stats.processors:flag_robots",
